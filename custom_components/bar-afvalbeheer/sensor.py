"""
Sensor component to monitor waste collection by BAR.
Original Author:  Floris Kruisselbrink <floris+homeassistant@vloris.nl>
Modification by: Remco770 <remco@vanlent.net>

This repo works in BAR (Barendrecht, Albrandswaard and Ridderkerk)
"""
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    _LOGGER.debug("Setting up BAR API Reader...")
...
class AbstractWasteSensor(Entity):
    ...
    def __init__(self, reader, sensor_type):
        self._reader = reader
        self._schedule = None
        self._name = "bar-afvalbeheer {}".format(SENSOR_TYPES[sensor_type][0])
